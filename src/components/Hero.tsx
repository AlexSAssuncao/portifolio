            ...
            <div className='container mx-auto max-w-4xl p-2 py-12 flex flex-col md:flex-row'>
                <div className='basis-1/2'>
                    <h1 className='mb-6'>
                        ...
                        <span className='font-headline text-5xl font-semibold'>Alex</span>
                        <span className='font-headline text-5xl font-light text-blue-500'> Assunção</span>
                    </h1>
                    ...
                    <div className='flex items-center gap-2 justify-center'>
                        <a href='#contact' className='underline font-bold text-white'>Meus Contatos</a>
